...
RUN apt-get -y install nginx zip supervisor git php7.3 php7.3-mysql php7.3-sqlite3 php7.3-pgsql php7.3-zip php7.3-imap php7.3-bcmath php7.3-memcached php7.3-fpm php7.3-mbstring php7.3-xml php7.3-curl php7.3-intl php7.3-readline php7.3-cli php7.3-imagick php7.3-dev php7.3-gd php7.3-soap nodejs
